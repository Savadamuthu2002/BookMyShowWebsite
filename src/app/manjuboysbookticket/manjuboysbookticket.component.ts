...
@Component({
  selector: 'app-manjuboysbookticket',
  templateUrl: './manjuboysbookticket.component.html',
  styleUrls: ['./manjuboysbookticket.component.css']
})
export class ManjuboysbookticketComponent {
