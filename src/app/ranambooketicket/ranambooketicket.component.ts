...
@Component({
  selector: 'app-ranambooketicket',
  templateUrl: './ranambooketicket.component.html',
  styleUrls: ['./ranambooketicket.component.css']
})
export class RanambooketicketComponent {
