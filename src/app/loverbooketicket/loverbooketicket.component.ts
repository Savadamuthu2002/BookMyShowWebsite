...
@Component({
  selector: 'app-loverbooketicket',
  templateUrl: './loverbooketicket.component.html',
  styleUrls: ['./loverbooketicket.component.css']
})
export class LoverbooketicketComponent {
