...
@Component({
  selector: 'app-ninetysixtheater',
  templateUrl: './ninetysixtheater.component.html',
  styleUrls: ['./ninetysixtheater.component.css']
})
export class NinetysixtheaterComponent {
