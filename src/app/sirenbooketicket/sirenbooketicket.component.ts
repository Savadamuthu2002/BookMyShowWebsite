...
@Component({
  selector: 'app-sirenbooketicket',
  templateUrl: './sirenbooketicket.component.html',
  styleUrls: ['./sirenbooketicket.component.css']
})
export class SirenbooketicketComponent {
