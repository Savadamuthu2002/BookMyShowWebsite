...
@Component({
  selector: 'app-manjuboystheater',
  templateUrl: './manjuboystheater.component.html',
  styleUrls: ['./manjuboystheater.component.css']
})
export class ManjuboystheaterComponent {
