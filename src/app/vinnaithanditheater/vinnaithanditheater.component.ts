...
@Component({
  selector: 'app-vinnaithanditheater',
  templateUrl: './vinnaithanditheater.component.html',
  styleUrls: ['./vinnaithanditheater.component.css']
})
export class VinnaithanditheaterComponent {
