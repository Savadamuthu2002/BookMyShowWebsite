...
@Component({
  selector: 'app-ninety-sixty-booketicket',
  templateUrl: './ninety-sixty-booketicket.component.html',
  styleUrls: ['./ninety-sixty-booketicket.component.css']
})
export class NinetySixtyBooketicketComponent {
