...
@Component({
  selector: 'app-vadakkupattitheater',
  templateUrl: './vadakkupattitheater.component.html',
  styleUrls: ['./vadakkupattitheater.component.css']
})
export class VadakkupattitheaterComponent {
