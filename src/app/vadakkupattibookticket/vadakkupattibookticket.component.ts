...
@Component({
  selector: 'app-vadakkupattibookticket',
  templateUrl: './vadakkupattibookticket.component.html',
  styleUrls: ['./vadakkupattibookticket.component.css']
})
export class VadakkupattibookticketComponent {
